      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 pt-12 md:pt-16 lg:pt-24 pb-8 md:pb-12 lg:pb-16">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 mb-8 md:mb-12 lg:mb-[73px]">
          <div className="lg:w-1/2">
            <p className="text-body  font-helvetica-now mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 mb-8 md:mb-12 lg:mb-[73px] items-center">
          ...
          <div className="lg:col-span-3">
            <div className="max-w-[325px]">
              <p className="text-h5 font-helvetica-now">
                ...
                <sup className="text-per-text font-bold">COMING SOON</sup><br/>
          ...
          <div className="lg:col-span-3 flex flex-col gap-6 justify-center">
            ...
            <button className="w-full py-3.5 px-6 md:px-[50px] bg-per-text rounded text-white text-body font-medium font-helvetica-now hover:bg-opacity-90 transition-colors">
