...
const targetingMethodsData: TargetingMethod[] = [
  {
    ...
    description: 'Small molecules provide rapid tissue and even cellular penetration. They potentially target intracellular proteins, and the ability to fit into small areas like enzyme binding sites. Their manufacturing offers relatively straightforward chemical synthesis pathways, scalable production processes, and longer shelf stability. Supply chains benefit from simpler transportation requirements and less stringent cold-chain needs.',
    tags: [
